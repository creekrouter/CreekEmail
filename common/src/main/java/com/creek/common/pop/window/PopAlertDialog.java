package com.creek.common.pop.window;
...
import com.creek.common.pop.view.PopAlertView;
import com.creek.common.pop.viewinterface.PopWindowInterface;
import com.creek.common.R;
import com.creek.common.pop.PopItemAction;
import com.creek.common.pop.PopSimpleAnimationListener;
...
public class PopAlertDialog extends Dialog implements PopWindowInterface, DialogInterface.OnShowListener, View.OnClickListener,
    ...
    public void setIsShowCircleBackground(boolean isShow) {
        ...
        if (!isShow) {
            mPopAlertDialog.setBackgroundColor(Color.parseColor("#00000000"));
        }
    }
