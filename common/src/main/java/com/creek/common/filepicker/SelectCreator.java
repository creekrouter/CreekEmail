package com.creek.common.filepicker;
...
import com.creek.common.filepicker.activity.SelectFileByBrowserActivity;
import com.creek.common.filepicker.activity.SelectFileByScanActivity;
import com.creek.common.filepicker.activity.SelectPictureActivity;
...
public final class SelectCreator {
    ...
    public void start() {
        ...
        if (fragment != null) {
            ...
            Launcher.startActivityForResult(activity,SelectFileByScanActivity.class,selectOptions.request_code);
        }
    }
