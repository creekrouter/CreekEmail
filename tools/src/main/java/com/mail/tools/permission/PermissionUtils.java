...
public final class PermissionUtils {
     ...
     */
    public static void postActivityResult(@NonNull List<String> permissions, @NonNull Runnable runnable) {
        long delayMillis;
     ...
     * 判断权限集合中是否包含某个权限
     */
    public static boolean containsPermission(@NonNull Collection<String> permissions, @NonNull String permission) {
