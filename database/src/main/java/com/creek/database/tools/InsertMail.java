...
public class InsertMail {
    public static ContentValues get(String folderName, IMAPMessage mailInfo, Set<MailContact> contacts) {
        ...
        values.put("subject_hash", DBTools.getSubjectHash(mailInfo.header().subject()));
...
//                    values.put("main_part", ObjectLocalUtil.objectToByte(mailInfo.mainPart()));
